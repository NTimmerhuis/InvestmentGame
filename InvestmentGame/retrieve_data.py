...
x = input("Geef een symbool?")

response = requests.get("https://www.alphavantage.co/query?function=TIME_SERIES_DAILY&symbol=" + x + "&outputsize=full&apikey=0I1LVMCSQ4CF9GSR")
